...
router.get('/', getAll);
router.post('/', basicAuth, bodyParser(), validatePetInfo, createPetrecord);
router.get('/:id([0-9]{1,})', getById);
router.put('/:id([0-9]{1,})', basicAuth, bodyParser(),validatePetInfo, updatePetrecord);
router.delete('/:id([0-9]{1,})', basicAuth, deletePetrecord);
